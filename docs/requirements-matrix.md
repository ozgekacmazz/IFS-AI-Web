...
| ID | Kaynak | Gereksinim | Planlanan uygulama | Katman / bileşen | Doğrulama | Durum |
|---|---|---|---|---|---|---|
| PDF-O-01 | Kullanıcı Akışı, s. 2 | Kullanıcı son üç özetini basit listede görebilir (**opsiyonel**). | Ürün kararıyla Phase 3 kapsamına alındı; yalnız mevcut kullanıcının başarılı kayıtları gösterilir. | React ana sayfa; Application; PostgreSQL | Kullanıcı yalnızca kendi son üç kaydını, doğru sırada görür. | Phase 3'te uygulandı |
