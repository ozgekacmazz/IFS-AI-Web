...
| ACIK-03 | Log içeriği | **Phase 3'te kısmen çözüldü:** Tam girdi ve başarılı tam özet 30 gün saklanır; başarısız denemede güvenli üst veri tutulur. `ExpiresAtUtc` vardır, zamanlanmış silme sonraki fazdadır. | Admin ekranındaki kısa önizleme, erişim ve zamanlanmış temizleme daha sonra uygulanacak. |
